    ...
    <?php } else { ?>
        <div class="post_wrapper" id="post_wrapper">
            ...
            <div class="post_section react_box">
                ...
                <button type="button" class="reacts heart" data-article-id="'.$seq.'">
                    <img src="./desginSource/ico/heart1.png" >
                    <img src="desginSource/ico/heart2.png"  style="display: none;">
                </button>
                <button class="reacts comment">
                    <img src="./desginSource/ico/comment.png" >
                </button>
                <button class="reacts share">
                    <img src="./desginSource/ico/share.png" >
                </button>
                <button class="reacts mark">
                    <img src="./desginSource/ico/mark.png" >
                </button>
            </div>
            <div class="post_section">
