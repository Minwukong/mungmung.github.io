...
$list_num = 15;     //한 페이지에 보여줄 게시물 수
$block_cnt = 5;     //블록당 보여줄 페이지 수
...
while ($row2 = mysqli_fetch_array($result2)) {
    if (($row2['img_test'])) {
        ...
        $list = $list . "<a class=\"postImg_wrapper\" href=\"php_post.php?id={$row2['id']}\"><img class=\"postImg\" src=\"./designSource/kyj/default_black.PNG\"><div class=\"darkness\"><p>{$row2['title']}</p></div></a>";
